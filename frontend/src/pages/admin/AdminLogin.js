// Admin login page with Google authentication
...
const AdminLogin = () => {
  ...
  const from = location.state?.from?.pathname || '/Mahia23/dashboard';
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      // Navigate to intended page or admin dashboard
      navigate(from, { replace: true });
    } catch (error) {
        ...
        <Card className="shadow-xl border-0 bg-white/80 backdrop-blur-sm">
          <CardHeader className="text-center space-y-2">
            ...
            <CardDescription className="text-gray-600">
              Sign in with your Google account to manage website content
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="text-center text-xs text-gray-500 border-t pt-4">
              <p><strong>Authorized admin accounts only:</strong></p>
              <div className="mt-2 space-y-1">
                <p className="font-mono text-xs bg-gray-100 px-2 py-1 rounded">socraticsoul01@gmail.com</p>
                <p className="font-mono text-xs bg-gray-100 px-2 py-1 rounded">abirsabirhossain@gmail.com</p>
              </div>
              <p className="mt-2">Other accounts will be denied access</p>
            </div>
          </CardContent>
        </Card>
      </div>
