                ...
                <div className="flex-1">
                  <div className="flex items-center space-x-2 mb-2">
                    <Switch
                      ...
                      onCheckedChange={(checked) => handleChange('featured', checked)}
                    />
                    <Label htmlFor="featured" className="font-semibold text-teal-900">
                      Featured Project
                    </Label>
                  </div>
                  <p className="text-xs text-teal-700">
                    Enable this to show the project on the home screen. Only featured projects with the lowest order numbers (1, 2, 3) will be displayed.
                  </p>
                </div>
              </div>
            </div>
